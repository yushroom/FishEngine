...
IF(MSVC)
	SET(FISHENGINE_COMPILER_NAME "vc")
	SET(FISHENGINE_COMPILER_MSVC TRUE)
	IF(MSVC_VERSION GREATER 1800)
		SET(FISHENGINE_COMPILER_VERSION "140")
	ELSEIF(MSVC_VERSION GREATER 1700)
		SET(FISHENGINE_COMPILER_VERSION "120")
	ENDIF()

	SET(CMAKE_CXX_FLAGS "/W4 /WX /EHsc /MP /bigobj")
	SET(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} /DFISHENGINE_SHIP /fp:fast /Ob2 /GL /Qpar")
	...
	IF(FISHENGINE_ARCH_NAME MATCHES "x86")
	...
	IF(MSVC_VERSION GREATER 1800)
		...
		IF(FISHENGINE_ARCH_NAME MATCHES "arm")
	...
	FUNCTION(CREATE_VCPROJ_USERFILE TARGETNAME)
		...
		CONFIGURE_FILE(
			${FISHENGINE_ROOT_DIR}/cmake/VisualStudio2010UserFile.vcxproj.user.in
...
ELSE()
	IF(CMAKE_C_COMPILER_ID STREQUAL "Clang")
		SET(FISHENGINE_COMPILER_NAME "clang")
		SET(FISHENGINE_COMPILER_CLANG TRUE)
		IF(FISHENGINE_PLATFORM_WINDOWS)
			ADD_DEFINITIONS(-D_WIN32_WINNT=0x0501)
		ENDIF()
	ELSEIF(MINGW)
		SET(FISHENGINE_COMPILER_NAME "mgw")
		SET(FISHENGINE_COMPILER_GCC TRUE)
		ADD_DEFINITIONS(-D_WIN32_WINNT=0x0501)
	ELSE()
		SET(FISHENGINE_COMPILER_NAME "gcc")
		SET(FISHENGINE_COMPILER_GCC TRUE)
	ENDIF()

	IF(FISHENGINE_COMPILER_CLANG)
		...
		SET(FISHENGINE_COMPILER_VERSION ${CLANG_MAJOR}${CLANG_MINOR})
		IF(FISHENGINE_PLATFORM_WINDOWS)
	...
	ELSE()
		...
		SET(FISHENGINE_COMPILER_VERSION ${GCC_MAJOR}${GCC_MINOR})
	ENDIF()
	...
	IF(FISHENGINE_COMPILER_CLANG)
		...
		IF(FISHENGINE_COMPILER_VERSION STRGREATER "35")
	...
	SET(CMAKE_CXX_FLAGS_RELEASE "-DNDEBUG -O2 -DFISHENGINE_SHIP")
	SET(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-DNDEBUG -g -O2")
	SET(CMAKE_CXX_FLAGS_MINSIZEREL "-DNDEBUG -Os")
	IF(FISHENGINE_ARCH_NAME STREQUAL "x86")
		...
		ENDIF()
	ELSEIF((FISHENGINE_ARCH_NAME STREQUAL "x64") OR (FISHENGINE_ARCH_NAME STREQUAL "x86_64"))
	...
	FUNCTION(CREATE_XCODE_USERFILE PROJECTNAME TARGETNAME)
		IF(FISHENGINE_PLATFORM_DARWIN OR FISHENGINE_PLATFORM_IOS)
			SET(SYSTEM_NAME $ENV{USERDOMAIN})
			SET(USER_NAME $ENV{USER})

			CONFIGURE_FILE(
				${FISHENGINE_ROOT_DIR}/cmake/xcode.xcscheme.in
...
IF(FISHENGINE_PLATFORM_LINUX)
	SET(CMAKE_CXX_FLAGS "-fpic ${CMAKE_CXX_FLAGS}")
	SET(CMAKE_C_FLAGS "-fpic ${CMAKE_C_FLAGS}")
ENDIF()

SET(FISHENGINE_OUTPUT_SUFFIX _${FISHENGINE_COMPILER_NAME}${FISHENGINE_COMPILER_VERSION})

FUNCTION(CREATE_PROJECT_USERFILE PROJECTNAME TARGETNAME)
	IF(MSVC)
		CREATE_VCPROJ_USERFILE(${TARGETNAME})
	ELSEIF(FISHENGINE_PLATFORM_DARWIN OR FISHENGINE_PLATFORM_IOS)
