...
namespace FishEngine
{
	...
	public:
		TCurveCache()
			: cachedKey((uint32_t)-1), cachedCurveStart(std::numeric_limits<float>::infinity()), cachedCurveEnd(0.0f)
	...
	//	friend class TAnimationCurve<T>;
		...
		mutable uint32_t cachedKey; /**< Left-most key the curve was last evaluated at. -1 if no cached data. */
